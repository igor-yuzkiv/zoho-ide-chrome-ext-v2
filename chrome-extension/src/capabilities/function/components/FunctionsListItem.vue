...
import { FunctionIcon } from '@/capabilities/function'
...
<template>
    <component
        ...
        v-tooltip="{ value: `${fx.type}: ${fx.displayName}` }"
    >
        <FunctionIcon :type="fx.type" class="shrink-0" />
        <div class="truncate">{{ fx.displayName }}</div>
    </component>
</template>
